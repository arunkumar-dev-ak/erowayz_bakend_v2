...
@ValidatorConstraint({ name: 'ValidateUpdateForProductUnit', async: false })
export class ValidUpdateProductUnitConstraint
  implements ValidatorConstraintInterface
{
  validate(_: any, args: ValidationArguments): boolean {
    const object = args.object as UpdateProductUnitDto;
...
export class UpdateProductUnitDto {
  ...
  @Validate(ValidUpdateProductUnitConstraint)
